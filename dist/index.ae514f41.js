...
})({"4Yrdy":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0322624aae514f41";
"use strict";
...
},{}],"eCK0a":[function(require,module,exports) {
...
const updateContainerscience = (science)=>{
    ...
    (science.results || []).slice(3).forEach((science_data)=>{
        if (!science_data.title || science_data.url === "null" || science_data.url === "") return;
        const newsContainerarts = document.createElement("li");
        newsContainerarts.setAttribute("class", "article");
        const imageUrl = science_data.multimedia && science_data.multimedia.length > 0 ? science_data.multimedia[0].url : "default-image-url.jpg";
...
const updateLatestNews = (news)=>{
    ...
    if (imageUrl) imgContainer.innerHTML = `<img src="${imageUrl}" alt="${news.title || "News Image"}">`;
...
(async ()=>{
    ...
    const validTopNews = (ud_datascience.results || []).find((news)=>news.title && news.url && news.url !== "null" && news.url !== "");
    if (validTopNews) updateLatestNews(validTopNews);
})();
...
fetchBookData();
/*for navigation */ const toggleBtn = document.querySelector(".toggle_btn");
const dropdownMenu = document.querySelector(".dropdown_menu");
const icon = toggleBtn ? toggleBtn.querySelector("i") : null;
if (toggleBtn && dropdownMenu && icon) toggleBtn.addEventListener("click", ()=>{
...
},{}]},["4Yrdy","eCK0a"], "eCK0a", "parcelRequiredbc7")

//# sourceMappingURL=index.ae514f41.js.map
